...
describe('save', () => {
  it('should create user', async () => {
    ...
    // TODO: fix the next check once you enable debugging. It's failing for some reason.
    // expect(before.getTime()).toBeLessThanOrEqual(fetched!.created.getTime())
    expect(fetched!.created.getTime()).toBeLessThanOrEqual(after.getTime())
  })
